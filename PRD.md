...
| D20 | Display target | A modern 4K monitor (3840×2160) is the default target for the first UI. The fixed internal resolution is chosen so that 4K is an integer multiple of it and a glyph pixel covers a few real pixels (3×3 at 4K), not the 12×12 of a 320×180 canvas; the 3D viewport keeps its coarser texels (16-pixel tiles at four canvas pixels a texel) | Keep the 320×180 canvas at 12× on 4K | Owner decision (2026-09-13): the display area is one of the things Omnis can improve over the 1980s originals, and the pixel-art feel is not worth sacrificing a better UI. Cheapest to change while the build is early. 1080p and 1440p stay supported at smaller integer scales. |
...
- **Exact detail depth and internal resolution:** a 1280×720 canvas with a 960×540 viewport since 2026-09-13 (D20): whole multiples at 720p, 1440p, and 4K; 1080p shows the canvas at 1× in a letterbox. Detail depth stays at 4 with the 16×16 placeholder tiles until the final art direction.
